...
import { addLinkLectureDocCourseFun } from '../../services/DoctorServices/coursesDocService';

export default function AddLinkDoc({setShowAddModalLinkLecture , nameLec , lecId}) {
  const [errormsg, setErrormsg] = useState("");
  const [loading, setLoading] = useState(false);
      console.log('idLe',lecId);
  ...
  const handleSubmit = async(e)=>{
    ...
    try{
      await addLinkLectureDocCourseFun(lecId,{ link:form.link})
      setShowAddModalLinkLecture(false);
    }catch(err){
      console.log(err);
      setErrormsg(
    ...
    <div className='notDoc'>
      <div className='modal-box'>
        <i
            ...
            onClick={() => setShowAddModalLinkLecture(false)}
        ></i>
